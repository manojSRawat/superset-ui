...
export default function transformProps(chartProps: TableChartProp) {
  const {
    height,
    width,
    formData,
  ...
  tableChartProps.queryData.data = {
    records: chartProps.queryData.data,
    columns: chartProps.queryData.data.length ? Object.keys(chartProps.queryData.data[0]) : [],
  };
